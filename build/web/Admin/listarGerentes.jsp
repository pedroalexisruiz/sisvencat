    ...
    <head>
        ...
        <%
            ...
            try {
                ...
                List<Gerente> gerentes = Fachada.getAdminN().getListadoDeGerentesPorEstado(1);
        %>
                    ...
                    <div class="col-md-9">
                        <div id="results" class="box">
                            <div id="divListado">
                                ...
                                <h1 class="text-primary">Listado de Gerentes Activos</h1>
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody class="buscar">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button name="btnGerenteADesactivar" type="submit" id="<%=gerente.getCedula()%>" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Desactivar"><i class="fa fa-trash-o"></i></button>
                                                    </td>
                                                </tr>
