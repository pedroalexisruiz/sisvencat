    ...
    <head>
        ...
        <%
            ...
            try {
                ...
                List<Vendedor> vendedores = Fachada.getAdminN().getListadoDeVendedoresPorEstado(2);
        %>
                            ...
                            <div class="col-md-9">
                                <div id="results" class="box">
                                    <div id="divListado">
                                        ...
                                        <h1 class="text-primary">Listado de Vendedores Inactivos</h1>

                                        <p class="lead">Desde esta sección podrás reactivar o modificar la información de cualquier vendedor inactivo.</p>
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody class="buscar">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <button name="btnVendedorAReactivar" type="submit" id="<%=vendedor.getCedula()%>" class="btn btn-xs btn-success" data-toggle="tooltip" title="Reactivar"><i class="fa fa-plus"></i></button>
                                                            </td>
                                                        </tr>
