            ...
            <ul id="listadeMenu" class="nav nav-pills nav-stacked">
                ...
                <li id="li4">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="divider"></li>
                        <li><a href="reactivarGerentes.jsp">Reactivar Gerente</a></li>
                    </ul>
                </li>
                <li id="li5">
                    <a href="" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>Control de Vendedores</a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="listarVendedores.jsp">Listado de Vendedores</a></li>
                        <li class="divider"></li>
                        <li><a href="reactivarVendedores.jsp">Reactivar Vendedor</a></li>
                    </ul>
                </li>
                <li id="li6">
