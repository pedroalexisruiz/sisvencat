                        ...
                        <div class="panel panel-default sidebar-menu">
                            ...
                            <div class="panel-body">
                                <ul id="listadeMenu" class="nav nav-pills nav-stacked">
                                    <li id="li1">
                                        <a href="ModificarDatos.jsp" id="modificardatos"><i class="fa fa-users"></i>Modificar Datos</a>
                                    </li>
                                    <li id="li2">
                                        <a id="campañas" href="carritoDeCompras.jsp"><i class="fa fa-shopping-cart"></i>Pedidos</a>
                                    </li>
                                    <li id="li3">
                                        <a href="verPremios.jsp" id="premios"><i class="fa fa-trophy"></i>Premios</a>
                                    </li>
                                    <li id="li4">
